...
我们提供了一个完整的示例项目，你可以直接运行查看效果：
[示例项目地址](https://github.com/your-repo/example)
...
1. 📱 用微信扫码登录[微信公众平台测试号系统](https://mp.weixin.qq.com/debug/cgi-bin/sandboxinfo)

[图片占位：展示测试号系统登录页面的截图]

2. 🔑 登录成功后，你会看到测试号信息页面

[图片占位：展示测试号信息页面，标注出appID和appsecret的位置]
...
2. ⚙️ 填写配置：
   ...
   - Token：可以随意填写，比如：`123456`（记住这个值）

[图片占位：展示接口配置区域，标注填写位置]
