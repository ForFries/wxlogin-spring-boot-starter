...
import com.forfries.wxlogin.DefaultWebSocketHandler;
...
public class WebSocketAutoConfiguration implements WebSocketConfigurer {
    ...
    public WebSocketAutoConfiguration(WeixinProperties weixinProperties, WeixinLoginService weixinLoginService, @Autowired(required = false) WebSocketHandler customWebSocketHandler) {
        this.weixinProperties = weixinProperties;
        // 如果开发者没有提供自定义的 WebSocketHandler，则使用默认实现
        this.webSocketHandler = customWebSocketHandler != null ? customWebSocketHandler : new DefaultWebSocketHandler(weixinLoginService);
    }
